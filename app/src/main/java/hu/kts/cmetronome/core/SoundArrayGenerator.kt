...
class SoundArrayGenerator @Inject constructor() {

    fun generateSoundArray(durationMillis: Int, up: Boolean): ShortArray {
        ...
        for (i in result.indices) {
            ...
            result[index] = (sample * Short.MAX_VALUE).toInt().toShort()
        }
        return result
    }
